...
[ExcludeClass]
internal class _UpdatePeerResultEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("message", "approved", "disableServer", "status", "pulseInterval", "disablePeer", "clientVersion");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("message");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("message", "approved", "disableServer", "status", "pulseInterval", "disablePeer", "clientVersion");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("message", "approved", "disableServer", "status", "pulseInterval", "disablePeer", "clientVersion");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("message", "approved", "disableServer", "status", "pulseInterval", "disablePeer", "clientVersion");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "UpdatePeerResult";
    ...
    model_internal var _instance:_Super_UpdatePeerResult;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _UpdatePeerResultEntityMetadata(value : _Super_UpdatePeerResult)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["disableServer"] = new Array();
            model_internal::dependentsOnMap["status"] = new Array();
            model_internal::dependentsOnMap["pulseInterval"] = new Array();
            model_internal::dependentsOnMap["disablePeer"] = new Array();
            model_internal::dependentsOnMap["clientVersion"] = new Array();
        ...
        model_internal::propertyTypeMap["disableServer"] = "int";
        model_internal::propertyTypeMap["status"] = "int";
        model_internal::propertyTypeMap["pulseInterval"] = "int";
        model_internal::propertyTypeMap["disablePeer"] = "int";
        model_internal::propertyTypeMap["clientVersion"] = "int";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity UpdatePeerResult");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity UpdatePeerResult");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of UpdatePeerResult");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity UpdatePeerResult");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity UpdatePeerResult");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isDisableServerAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isPulseIntervalAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isDisablePeerAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isClientVersionAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get disableServerStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get pulseIntervalStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get disablePeerStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get clientVersionStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
