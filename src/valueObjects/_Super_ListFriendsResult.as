 ...
 * of this value object you may modify the generated sub-class of this class - ListFriendsResult.as.
 */
...
[ExcludeClass]
public class _Super_ListFriendsResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.FriendList.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ListFriendsResultEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.FriendList;
    ...
    public function _Super_ListFriendsResult()
    {
        _model = new _ListFriendsResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ListFriendsResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ListFriendsResultEntityMetadata) : void
    {
        var oldValue : _ListFriendsResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
