 ...
 * of this value object you may modify the generated sub-class of this class - ListGroupResult.as.
 */
...
[ExcludeClass]
public class _Super_ListGroupResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.GroupData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ListGroupResultEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.GroupData;
    ...
    public function _Super_ListGroupResult()
    {
        _model = new _ListGroupResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ListGroupResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ListGroupResultEntityMetadata) : void
    {
        var oldValue : _ListGroupResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
