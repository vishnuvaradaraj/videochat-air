 ...
 * of this value object you may modify the generated sub-class of this class - ListBuddyResult.as.
 */
...
[ExcludeClass]
public class _Super_ListBuddyResult extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    {
        valueObjects.BuddyData.initRemoteClassAliasSingleChild();
    }

    model_internal var _dminternal_model : _ListBuddyResultEntityMetadata;
    ...
    model_internal var _internal_data_leaf:valueObjects.BuddyData;
    ...
    public function _Super_ListBuddyResult()
    {
        _model = new _ListBuddyResultEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ListBuddyResultEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ListBuddyResultEntityMetadata) : void
    {
        var oldValue : _ListBuddyResultEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
